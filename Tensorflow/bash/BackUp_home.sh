...
#tar cvfz ~/d/PrjsBackup/MyDL_${sDate}.tgz \
#        --exclude=build \
#        --exclude=bin \
#        --exclude=lib \
...
#~/MyDL 备份
#tar cvfz ~/d/home_backup/home_backup_${sDate}.tgz \
#        --exclude=test/d \
#        --exclude=test/e \
#    ~/test
...
#shell指令操作【ubuntu】 - cp指令如何用管道传参数
#   https://blog.csdn.net/rig622/article/details/7790594
#只显示应藏文件  
# ls -AF |grep '^\.'

ls ~/ -AF|grep '^\.'|grep -v .cache|xargs tar cvfz ~/d/home_backup/home_backup_${sDate}.tgz
