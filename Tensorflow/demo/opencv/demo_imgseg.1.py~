...
def params():
    ...
    # Add argument
    parser.add_argument('--srcpath',type=str , help='源目录. eg. --srcpath "./temp1"',default='./temp1');    
    parser.add_argument('--savepath',type=str , help='保存目录. eg. --savepath "./temp2"',default='./temp2');
