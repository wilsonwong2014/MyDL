...
'''
NumPy API（十七）——掩码数组操作
    https://www.jianshu.com/p/7f299f1c1169
...
作者：无赖宵小
链接：https://www.jianshu.com/p/7f299f1c1169
来源：简书
...
print(np.ma.compress_rowcols(x))

print(np.ma.compress_rowcols(x, 0))

print(np.ma.compress_rowcols(x, 1))
